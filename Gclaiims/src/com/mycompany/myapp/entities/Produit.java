...
public class Produit {
    ...
    public Produit(int id_produit, String nom_produit, String description, double prix_produit, Date dateAjout_produit, int Qte_produit, int nbr_vu) {
    ...
    public String toString() {
        return "Produit{" + "id_produit=" + id_produit + ", nom_produit=" + nom_produit + ", description=" + description + ", prix_produit=" + prix_produit + ", dateAjout_produit=" + dateAjout_produit + ", Qte_produit=" + Qte_produit + ", nbr_vu=" + nbr_vu + '}';
    }

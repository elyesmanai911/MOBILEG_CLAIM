 ...
 * @author User
 */
public class AfficheCommentaireForm extends BaseForm{
 ...
 Form current;
    ...
    public AfficheCommentaireForm(Form previous,Resources res,Article a) {
        ...
        swipe.getContentPane().setUIID("Container");
        swipe.hideTabs();
              setTitle("Add Commentaire");
        setLayout(BoxLayout.yCenter());
        
        System.out.println(ServiceArticle.getInstance().getAllArticle());
                
        TextField tfCommentaire = new TextField(""," commentaire ");
        tfCommentaire.getAllStyles().setFgColor(0x000000);
        TextField tfuser = new TextField(SessionManager.getUserName());
        tfuser.getAllStyles().setFgColor(0x000000);
...
//        TextField tfID_Artiste = new TextField("","Artist ID");
        ...
        btnValider.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent evt) {
                 if ((tfCommentaire.getText().length()==0)||(tfuser.getText().length()==0))
                    Dialog.show("Alert", "Please fill all the fields", new Command("OK"));
                 else {
                    try {
                     
                        
                        if(ServiceArticle.getInstance().addCom(tfCommentaire, tfuser,a))
  ...
  Dialog.show("Success","Connection accepted",new Command("OK"));
        ...
        addAll(tfCommentaire,tfuser,btnValider);

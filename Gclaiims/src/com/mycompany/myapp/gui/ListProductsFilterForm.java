 ...
 * @author user
 */
public class ListProductsFilterForm extends BaseFormBack {

    public ListProductsFilterForm(Form previous,Resources res, ArrayList<Produit> list) throws IOException {

...
public ArrayList<Article> articles;
    public ArticleForm(Form previous,Resources res) {
...
all.addActionListener( (e) -> {
       ...
       articles=ServiceArticle.getInstance().getAllArticle();
for (Article e :articles)
{ addButton(res.getImage("news-item-1.jpg"),e.getTitre()+ "\n" +e.getDescription()+ "\n" , false, 26, 32);
...
Modif.addPointerPressedListener(ll->new AfficheArticleForm(current,res,e).show());

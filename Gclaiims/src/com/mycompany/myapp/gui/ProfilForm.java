...
public ArrayList<Profil> Profils;
    public ProfilForm(Form previous,Resources res) {
        ...
        RadioButton Profil = RadioButton.createToggle("Equipe", barGroup);
        Profil.setUIID("SelectBar");
        RadioButton popular = RadioButton.createToggle("Coachs", barGroup);
        popular.setUIID("SelectBar");
        RadioButton myFavorite = RadioButton.createToggle("Tournoi", barGroup);
        myFavorite.setUIID("SelectBar");
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
        
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(4, all, Profil, popular, myFavorite),
        ...
        bindButtonSelection(Profil, arrow);

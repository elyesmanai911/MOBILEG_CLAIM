...
public class AfficheArticleForm extends BaseForm{
Form current;
public ArrayList<Article> articles;
public ArrayList<Commentaire> commentaires;

    public AfficheArticleForm(Form previous,Resources res, Article a) {
        super("ListArticle", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Liste Article");
...
all.addActionListener( (e) -> {
       ...
       articles=ServiceArticle.getInstance().getaffichearticlejson(a.getId());
addButton(res.getImage("news-item-1.jpg"),a.getTitre()+ "\n" +a.getDescription()+ "\n" , false, 26, 32);
       sp.setText(sp.getText()+"\n"+a.getDescription().toString());
       Label Modif =new Label("lire");
Modif.setUIID("NewsTopLine");
Style modifStyle =new Style(Modif.getUnselectedStyle());
modifStyle.setFgColor(0xf7ad02);
FontImage mfontimage=FontImage.createMaterial(FontImage.MATERIAL_READ_MORE,modifStyle);
...
Modif.setTextPosition(LEFT);
 ...
 // add(sp);
      ...
      SpanLabel sp1 = new SpanLabel();
       commentaires =ServiceArticle.getInstance().getAffcheCommentaire(a);
for (Commentaire e :commentaires)
{ addButton(res.getImage("news-item-1.jpg"),e.getCommentaire()+ "\n" +e.getUser()+ "\n" , false, 26, 32);
Modif.setUIID("NewsTopLine");
Style modifStyle1 =new Style(Modif.getUnselectedStyle());
modifStyle1.setFgColor(0xf7ad02);
FontImage mfontimage1 =FontImage.createMaterial(FontImage.MATERIAL_READ_MORE,modifStyle);
Modif.setIcon(mfontimage);
Modif.setTextPosition(LEFT);
...
Button next = new Button("ajouter commentaire");
        addStringValue("", BoxLayout.encloseY(next));
                next.addActionListener(e -> new AfficheCommentaireForm(current,res,a).show());

 ...
 * @author User
 */
public class ListCommentaireBackForm extends BaseFormBack {

    public ListCommentaireBackForm (Form previous,Resources res) throws IOException {
        ...
        list = new ArrayList<>();
        list = ServiceArticle.getInstance().getAllCommentaires();
        ...
        for ( Commentaire a : list) {
         ...
         SpanLabel spl = new SpanLabel("Titre de l article: " + "  " + a.getCommentaire()); 
          SpanLabel spl7 = new SpanLabel("Description: " + "  " + a.getUser());
